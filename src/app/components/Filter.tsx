  ...
  return (
    <div className="w-full lg:w-fit border border-secondary rounded-lg p-4 bg-white/5 backdrop-blur-sm space-y-6">
      ...
      <div className="flex justify-center pt-1">
        <button
          onClick={onclick}
          className="bg-[#1E5D50] text-white font-bold px-8 py-2.5 rounded-full text-sm hover:bg-[#16483E] hover:shadow-[0_0_18px_rgba(30,93,80,0.35)] active:scale-95 transition-all duration-300"
        >
          Apply Filter
        </button>
      </div>
