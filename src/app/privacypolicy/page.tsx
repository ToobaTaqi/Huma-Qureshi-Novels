  ...
  return (
    <div className="flex flex-col gap-6 py-5">
      ...
      {/* Content */}
        ...
        <div className="bg-[#FFFDF9] rounded-2xl border-2 border-[#DCCFC2] p-4 sm:p-4 sm:p-6 lg:p-8 flex flex-col gap-4 break-words overflow-hidden break-words overflow-hidden">
